...
label k_history:
    ...
    pause (1)
    "В августе 1999 года подлодка выполнила ракетные стрельбы на приз главкома ВМФ России. В результате чего, К-141 признан лучшим в 7-й дивизии."
    "Экипаж «Курска» принимал участие в военно-морском параде, посвящённом Дню Военно-морского флота в Североморске."

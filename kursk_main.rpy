...
label k_after_sailing:
    $ new_chapter(3, u"Курск: Отплытие. 10 августа, 9:30")
    $ updVisual()
    ...
    su "Глубина какая?"
    sk "40 метров!"
    su "Всплытие до 10, приготовиться к запуску ракеты!"
    sk "Есть всплытие 10!"
    window hide
    scene torpeda1 with dissolve2
    window show
    torp "Время без пяти минут десять, сейчас «Гранит», а потом наша учебка."
    torp "Что там с ней кстати?"
    dag "Все показатели в норме."
    torp "Отлично."
    ...
    su "Погружкеме до 40 метров, взять курс 130 градусов, установить скорость 25 узлов."

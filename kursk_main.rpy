...
label peter_the_great:
    ...
    "{cps=+65}{font=[cursive]}{vspace=20}{space=40}{color=#2961ee}{size=+20}11:09 - Зафиксированы посылки локаторов в виде импульсов. Подводная лодка ведет гидроакустический поиск. Пеленг 96 градусов."
    "{vspace=32}После этого сигналов от субмарины больше не поступало."
    ...
    play sound_1 PenSound1
    "{cps=+65}{font=[cursive]}{vspace=20}{space=40}{color=#2961ee}{size=+20}11:15 - Северо-западнее места нахождения корабля проплыл большой косяк рыбы."
    "{vspace=32}Моряки очень хорошо научились различать данный звук, потому как Баренцего море буквально кишит треской."

...
label peter_the_great:
    ...
    $ updVisual()
    play ambience hydro_ambience fadein 3
    scene hydro with Dissolve(3)
    $ set_mode_nvl()
    window show
    "Тем временем на борту атомного крейсера «Пётр Великий» ничего не предвещает беды."
    play sound scan fadein 2 volume 0.3
    "Находившийся на посту командир гидроакустической службы лейтенант Киров, вглядываясь в экран локатора обнаружил характерный сигнал."
    "Выясняется, что он исходил от К-141, производящей замер дистанции до цели."
    stop sound fadeout 2
    "В бортовой журнал вносится запись:"
    play sound_1 PenSound1
    "{cps=+65}{font=[cursive]}{vspace=20}{color=#2961ee}{size=+9}11:09 - зафиксированы посылки локаторов в виде импульсов. Подводная лодка ведет гидроакустический поиск. Пеленг 96 градусов"
    "{vspace=+12}После этого сигналов от субмарины больше не поступало."
    "Спустя несколько минут гидролокатор уловил новое акустическое явление, в динамиках послышался шум."
    "Лейтенант заносит это в журнал."
    play sound_1 PenSound1
    "{cps=+65}{font=[cursive]}{vspace=20}{color=#2961ee}{size=+12}11:15 - северо-западнее места нахождения корабля проплыл большой косяк рыбы"
    "{vspace=12}Моряки очень хорошо научились различать данный звук, потому как Баренцего море буквально кишит треской."
    "Следующие пятнадцать минут в море ничего не происходит, всё тихо."
    play sound Suddenly4
    scene black
    show hydro at k_shaking
    "Внезапно многотонный крейсер содрогнулся от гидродинамического удара."
    "По поверхности судна пробегает дрож."
    play sound Suddenly9
    "Через мгновение в динамике раздался хлопок."
    "Лейтенант Киров отметил в журнале:"
    play sound_1 PenSound1
    "{cps=+65}{font=[cursive]}{vspace=20}{color=#2961ee}{size=+12}В 11:30 на индикаторе кругового обзора наблюдал сигнал, который выглядел как вспышка на экране размером с пятирублевую монету"
    "{vspace=+12}Заподозрив неладное, Киров докладывает о явлении капитану корабля."
    stop ambience fadeout 3
    scene black with Dissolve(3)
    jump in_9_ots
